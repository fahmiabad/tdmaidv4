...
- PK results: {res}
Provide concise interpretation, dosing recommendation, and rationale.
"""
...
if mode == "Initial Dose":
    ...
    dose_int = st.sidebar.number_input("Dose per Interval (mg)", 0, step=250, value=1000)
    trough = st.sidebar.number_input("Measured Trough (mg/L)", 0.1, 100.0, 10.0)
    ...
    cmin = st.sidebar.number_input("Cmin (mg/L)", 0.1, 100.0, 10.0)
    cpost = st.sidebar.number_input("Cpost (mg/L)", 0.1, 200.0, 30.0)
